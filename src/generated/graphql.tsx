 ...
 * });
 */
export function useGetOwnerQuery(baseOptions: Apollo.QueryHookOptions<GetOwnerQuery, GetOwnerQueryVariables> & ({ variables: GetOwnerQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetOwnerSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetOwnerQuery, GetOwnerQueryVariables>): Apollo.UseSuspenseQueryResult<GetOwnerQuery, GetOwnerQueryVariables>;
export function useGetOwnerSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetOwnerQuery, GetOwnerQueryVariables>): Apollo.UseSuspenseQueryResult<GetOwnerQuery | undefined, GetOwnerQueryVariables>;
export function useGetOwnerSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetOwnerQuery, GetOwnerQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetOwnerQuery, GetOwnerQueryVariables>(GetOwnerDocument, options);
        }
...
export type GetOwnerSuspenseQueryHookResult = ReturnType<typeof useGetOwnerSuspenseQuery>;
...
// @ts-ignore
export function useGetDoctorsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetDoctorsQuery, GetDoctorsQueryVariables>): Apollo.UseSuspenseQueryResult<GetDoctorsQuery, GetDoctorsQueryVariables>;
export function useGetDoctorsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetDoctorsQuery, GetDoctorsQueryVariables>): Apollo.UseSuspenseQueryResult<GetDoctorsQuery | undefined, GetDoctorsQueryVariables>;
...
// @ts-ignore
export function useGetDoctorSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetDoctorQuery, GetDoctorQueryVariables>): Apollo.UseSuspenseQueryResult<GetDoctorQuery, GetDoctorQueryVariables>;
export function useGetDoctorSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetDoctorQuery, GetDoctorQueryVariables>): Apollo.UseSuspenseQueryResult<GetDoctorQuery | undefined, GetDoctorQueryVariables>;
...
// @ts-ignore
export function useGetPetSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetPetQuery, GetPetQueryVariables>): Apollo.UseSuspenseQueryResult<GetPetQuery, GetPetQueryVariables>;
export function useGetPetSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetPetQuery, GetPetQueryVariables>): Apollo.UseSuspenseQueryResult<GetPetQuery | undefined, GetPetQueryVariables>;
...
export const UpdateDoctorProfileDocument = gql`
  ...
  updateDoctorProfile(input: $input) {
    ...
    `;
export type UpdateDoctorProfileMutationFn = Apollo.MutationFunction<UpdateDoctorProfileMutation, UpdateDoctorProfileMutationVariables>;

/**
 * __useUpdateDoctorProfileMutation__
 *
 * To run a mutation, you first call `useUpdateDoctorProfileMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateDoctorProfileMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateDoctorProfileMutation, { data, loading, error }] = useUpdateDoctorProfileMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateDoctorProfileMutation(baseOptions?: Apollo.MutationHookOptions<UpdateDoctorProfileMutation, UpdateDoctorProfileMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateDoctorProfileMutation, UpdateDoctorProfileMutationVariables>(UpdateDoctorProfileDocument, options);
      }
export type UpdateDoctorProfileMutationHookResult = ReturnType<typeof useUpdateDoctorProfileMutation>;
export type UpdateDoctorProfileMutationResult = Apollo.MutationResult<UpdateDoctorProfileMutation>;
export type UpdateDoctorProfileMutationOptions = Apollo.BaseMutationOptions<UpdateDoctorProfileMutation, UpdateDoctorProfileMutationVariables>;
export const AddDoctorSpecializationDocument = gql`
  ...
  addDoctorSpecialization(input: $input) {
    ...
    `;
export type AddDoctorSpecializationMutationFn = Apollo.MutationFunction<AddDoctorSpecializationMutation, AddDoctorSpecializationMutationVariables>;

/**
 * __useAddDoctorSpecializationMutation__
 *
 * To run a mutation, you first call `useAddDoctorSpecializationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddDoctorSpecializationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addDoctorSpecializationMutation, { data, loading, error }] = useAddDoctorSpecializationMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAddDoctorSpecializationMutation(baseOptions?: Apollo.MutationHookOptions<AddDoctorSpecializationMutation, AddDoctorSpecializationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddDoctorSpecializationMutation, AddDoctorSpecializationMutationVariables>(AddDoctorSpecializationDocument, options);
      }
export type AddDoctorSpecializationMutationHookResult = ReturnType<typeof useAddDoctorSpecializationMutation>;
export type AddDoctorSpecializationMutationResult = Apollo.MutationResult<AddDoctorSpecializationMutation>;
export type AddDoctorSpecializationMutationOptions = Apollo.BaseMutationOptions<AddDoctorSpecializationMutation, AddDoctorSpecializationMutationVariables>;
export const UpdateDoctorSpecializationDocument = gql`
    mutation UpdateDoctorSpecialization($input: UpdateDoctorSpecializationInput!) {
  updateDoctorSpecialization(input: $input) {
    ...
    `;
export type UpdateDoctorSpecializationMutationFn = Apollo.MutationFunction<UpdateDoctorSpecializationMutation, UpdateDoctorSpecializationMutationVariables>;

/**
 * __useUpdateDoctorSpecializationMutation__
 *
 * To run a mutation, you first call `useUpdateDoctorSpecializationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateDoctorSpecializationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateDoctorSpecializationMutation, { data, loading, error }] = useUpdateDoctorSpecializationMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateDoctorSpecializationMutation(baseOptions?: Apollo.MutationHookOptions<UpdateDoctorSpecializationMutation, UpdateDoctorSpecializationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateDoctorSpecializationMutation, UpdateDoctorSpecializationMutationVariables>(UpdateDoctorSpecializationDocument, options);
      }
export type UpdateDoctorSpecializationMutationHookResult = ReturnType<typeof useUpdateDoctorSpecializationMutation>;
export type UpdateDoctorSpecializationMutationResult = Apollo.MutationResult<UpdateDoctorSpecializationMutation>;
export type UpdateDoctorSpecializationMutationOptions = Apollo.BaseMutationOptions<UpdateDoctorSpecializationMutation, UpdateDoctorSpecializationMutationVariables>;
export const RemoveDoctorSpecializationDocument = gql`
    mutation RemoveDoctorSpecialization($input: RemoveDoctorSpecializationInput!) {
  removeDoctorSpecialization(input: $input) {
    ...
    `;
export type RemoveDoctorSpecializationMutationFn = Apollo.MutationFunction<RemoveDoctorSpecializationMutation, RemoveDoctorSpecializationMutationVariables>;

/**
 * __useRemoveDoctorSpecializationMutation__
 *
 * To run a mutation, you first call `useRemoveDoctorSpecializationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRemoveDoctorSpecializationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [removeDoctorSpecializationMutation, { data, loading, error }] = useRemoveDoctorSpecializationMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useRemoveDoctorSpecializationMutation(baseOptions?: Apollo.MutationHookOptions<RemoveDoctorSpecializationMutation, RemoveDoctorSpecializationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveDoctorSpecializationMutation, RemoveDoctorSpecializationMutationVariables>(RemoveDoctorSpecializationDocument, options);
      }
export type RemoveDoctorSpecializationMutationHookResult = ReturnType<typeof useRemoveDoctorSpecializationMutation>;
export type RemoveDoctorSpecializationMutationResult = Apollo.MutationResult<RemoveDoctorSpecializationMutation>;
export type RemoveDoctorSpecializationMutationOptions = Apollo.BaseMutationOptions<RemoveDoctorSpecializationMutation, RemoveDoctorSpecializationMutationVariables>;
export const AddDoctorAvailabilityDocument = gql`
  ...
  addDoctorAvailability(input: $input) {
    ...
    `;
export type AddDoctorAvailabilityMutationFn = Apollo.MutationFunction<AddDoctorAvailabilityMutation, AddDoctorAvailabilityMutationVariables>;

/**
 * __useAddDoctorAvailabilityMutation__
 *
 * To run a mutation, you first call `useAddDoctorAvailabilityMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddDoctorAvailabilityMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addDoctorAvailabilityMutation, { data, loading, error }] = useAddDoctorAvailabilityMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAddDoctorAvailabilityMutation(baseOptions?: Apollo.MutationHookOptions<AddDoctorAvailabilityMutation, AddDoctorAvailabilityMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddDoctorAvailabilityMutation, AddDoctorAvailabilityMutationVariables>(AddDoctorAvailabilityDocument, options);
      }
export type AddDoctorAvailabilityMutationHookResult = ReturnType<typeof useAddDoctorAvailabilityMutation>;
export type AddDoctorAvailabilityMutationResult = Apollo.MutationResult<AddDoctorAvailabilityMutation>;
export type AddDoctorAvailabilityMutationOptions = Apollo.BaseMutationOptions<AddDoctorAvailabilityMutation, AddDoctorAvailabilityMutationVariables>;
export const RemoveDoctorAvailabilityDocument = gql`
  ...
  removeDoctorAvailability(input: $input) {
    ...
    `;
export type RemoveDoctorAvailabilityMutationFn = Apollo.MutationFunction<RemoveDoctorAvailabilityMutation, RemoveDoctorAvailabilityMutationVariables>;

/**
 * __useRemoveDoctorAvailabilityMutation__
 *
 * To run a mutation, you first call `useRemoveDoctorAvailabilityMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRemoveDoctorAvailabilityMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [removeDoctorAvailabilityMutation, { data, loading, error }] = useRemoveDoctorAvailabilityMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useRemoveDoctorAvailabilityMutation(baseOptions?: Apollo.MutationHookOptions<RemoveDoctorAvailabilityMutation, RemoveDoctorAvailabilityMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveDoctorAvailabilityMutation, RemoveDoctorAvailabilityMutationVariables>(RemoveDoctorAvailabilityDocument, options);
      }
export type RemoveDoctorAvailabilityMutationHookResult = ReturnType<typeof useRemoveDoctorAvailabilityMutation>;
export type RemoveDoctorAvailabilityMutationResult = Apollo.MutationResult<RemoveDoctorAvailabilityMutation>;
export type RemoveDoctorAvailabilityMutationOptions = Apollo.BaseMutationOptions<RemoveDoctorAvailabilityMutation, RemoveDoctorAvailabilityMutationVariables>;
...
export const UpdateOwnerProfileDocument = gql`
  ...
  updateOwnerProfile(input: $input) {
    ...
    `;
export type UpdateOwnerProfileMutationFn = Apollo.MutationFunction<UpdateOwnerProfileMutation, UpdateOwnerProfileMutationVariables>;

/**
 * __useUpdateOwnerProfileMutation__
 *
 * To run a mutation, you first call `useUpdateOwnerProfileMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateOwnerProfileMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateOwnerProfileMutation, { data, loading, error }] = useUpdateOwnerProfileMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateOwnerProfileMutation(baseOptions?: Apollo.MutationHookOptions<UpdateOwnerProfileMutation, UpdateOwnerProfileMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateOwnerProfileMutation, UpdateOwnerProfileMutationVariables>(UpdateOwnerProfileDocument, options);
      }
export type UpdateOwnerProfileMutationHookResult = ReturnType<typeof useUpdateOwnerProfileMutation>;
export type UpdateOwnerProfileMutationResult = Apollo.MutationResult<UpdateOwnerProfileMutation>;
export type UpdateOwnerProfileMutationOptions = Apollo.BaseMutationOptions<UpdateOwnerProfileMutation, UpdateOwnerProfileMutationVariables>;